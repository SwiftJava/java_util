...
open class Properties: Hashtable {
    ...
    open var defaults: Properties! {
        get {
            ...
            return JNIType.toSwift( type: Properties(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open func getProperty( arg0: String? ) -> String! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getProperty", methodSig: "(Ljava/lang/String;)Ljava/lang/String;", methodCache: &Properties.getProperty_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getProperty( arg0: String?, arg1: String? ) -> String! {
        ...
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getProperty", methodSig: "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", methodCache: &Properties.getProperty_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: String(), from: __return )
    }
    ...
    open func list( _ _arg0: /* java.io.PrintWriter */ UnclassedObject? ) {
        list( arg0: _arg0 )
    }
    ...
    private static var load_MethodID_7: jmethodID?
    ...
    open func store( _ _arg0: /* java.io.OutputStream */ UnclassedObject?, _ _arg1: String? ) throws /* java.io.IOException */ {
