...
open class Semaphore: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var reducePermits_MethodID_3: jmethodID?

    open func reducePermits( reduction: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: reduction, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "reducePermits", methodSig: "(I)V", methodCache: &Semaphore.reducePermits_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var drainPermits_MethodID_4: jmethodID?

    open func drainPermits() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "drainPermits", methodSig: "()I", methodCache: &Semaphore.drainPermits_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func isFair() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFair", methodSig: "()Z", methodCache: &Semaphore.isFair_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func hasQueuedThreads() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "hasQueuedThreads", methodSig: "()Z", methodCache: &Semaphore.hasQueuedThreads_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var getQueueLength_MethodID_10: jmethodID?

    open func getQueueLength() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getQueueLength", methodSig: "()I", methodCache: &Semaphore.getQueueLength_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getQueuedThreads_MethodID_11: jmethodID?

    open func getQueuedThreads() -> Collection! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getQueuedThreads", methodSig: "()Ljava/util/Collection;", methodCache: &Semaphore.getQueuedThreads_MethodID_11, args: &__args, locals: &__locals )
    ...
    private static var release_MethodID_12: jmethodID?

    open func release() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "release", methodSig: "()V", methodCache: &Semaphore.release_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func release( permits: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: permits, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "release", methodSig: "(I)V", methodCache: &Semaphore.release_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func tryAcquire( permits: Int, timeout: Int64, unit: TimeUnit? ) throws /* java.lang.InterruptedException */ -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "tryAcquire", methodSig: "(IJLjava/util/concurrent/TimeUnit;)Z", methodCache: &Semaphore.tryAcquire_MethodID_14, args: &__args, locals: &__locals )
    ...
    private static var tryAcquire_MethodID_15: jmethodID?
    ...
    open func tryAcquire( timeout: Int64, unit: TimeUnit? ) throws /* java.lang.InterruptedException */ -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "tryAcquire", methodSig: "(JLjava/util/concurrent/TimeUnit;)Z", methodCache: &Semaphore.tryAcquire_MethodID_15, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.InterruptedException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    open func tryAcquire() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "tryAcquire", methodSig: "()Z", methodCache: &Semaphore.tryAcquire_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func tryAcquire( permits: Int ) -> Bool {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: permits, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "tryAcquire", methodSig: "(I)Z", methodCache: &Semaphore.tryAcquire_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var acquire_MethodID_18: jmethodID?

    open func acquire( permits: Int ) throws /* java.lang.InterruptedException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: permits, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "acquire", methodSig: "(I)V", methodCache: &Semaphore.acquire_MethodID_18, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.InterruptedException( javaObject: throwable )
        }
    }
    ...
    private static var acquire_MethodID_19: jmethodID?

    open func acquire() throws /* java.lang.InterruptedException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "acquire", methodSig: "()V", methodCache: &Semaphore.acquire_MethodID_19, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.InterruptedException( javaObject: throwable )
        }
    }
