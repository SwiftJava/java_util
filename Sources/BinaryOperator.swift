...
open class BinaryOperatorForward: BiFunctionForward, BinaryOperator {
    ...
    private static var minBy_MethodID_3: jmethodID?
    ...
    open class func minBy( comparator: JavaComparator? ) -> BinaryOperator! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/util/function/BinaryOperator", classCache: &BinaryOperatorJNIClass, methodName: "minBy", methodSig: "(Ljava/util/Comparator;)Ljava/util/function/BinaryOperator;", methodCache: &minBy_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var maxBy_MethodID_4: jmethodID?

    open class func maxBy( comparator: JavaComparator? ) -> BinaryOperator! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: comparator, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/util/function/BinaryOperator", classCache: &BinaryOperatorJNIClass, methodName: "maxBy", methodSig: "(Ljava/util/Comparator;)Ljava/util/function/BinaryOperator;", methodCache: &maxBy_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? BinaryOperatorForward( javaObject: __return ) : nil
    }
    ...
    override open func apply( t: java_swift.JavaObject?, u: java_swift.JavaObject? ) -> java_swift.JavaObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "apply", methodSig: "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", methodCache: &BinaryOperatorForward.apply_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func andThen( after: Function? ) -> BiFunction! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "andThen", methodSig: "(Ljava/util/function/Function;)Ljava/util/function/BiFunction;", methodCache: &BinaryOperatorForward.andThen_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
