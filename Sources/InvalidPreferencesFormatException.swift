...
open class InvalidPreferencesFormatException: java_lang.Exception {

    public convenience init?( casting object: java_swift.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.util.prefs.InvalidPreferencesFormatException", file, line ) {
            return nil
        }
    ...
    private static var InvalidPreferencesFormatExceptionJNIClass: jclass?

    /// private static final long java.util.prefs.InvalidPreferencesFormatException.serialVersionUID
