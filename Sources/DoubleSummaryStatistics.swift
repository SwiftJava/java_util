...
open class DoubleSummaryStatistics: java_swift.JavaObject, DoubleConsumer {
    ...
    open func getCount() -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallLongMethod( object: javaObject, methodName: "getCount", methodSig: "()J", methodCache: &DoubleSummaryStatistics.getCount_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getSum() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getSum", methodSig: "()D", methodCache: &DoubleSummaryStatistics.getSum_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func getMin() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getMin", methodSig: "()D", methodCache: &DoubleSummaryStatistics.getMin_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getMax() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getMax", methodSig: "()D", methodCache: &DoubleSummaryStatistics.getMax_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getAverage() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getAverage", methodSig: "()D", methodCache: &DoubleSummaryStatistics.getAverage_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
