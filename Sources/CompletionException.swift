...
open class CompletionException: java_lang.RuntimeException {
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/CompletionException", classCache: &CompletionException.CompletionExceptionJNIClass, methodSig: "()V", methodCache: &CompletionException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( message: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/CompletionException", classCache: &CompletionException.CompletionExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &CompletionException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( message: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/CompletionException", classCache: &CompletionException.CompletionExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &CompletionException.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/CompletionException", classCache: &CompletionException.CompletionExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &CompletionException.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
