...
open class ReentrantReadWriteLock: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open func readLock() -> Lock! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "readLock", methodSig: "()Ljava/util/concurrent/locks/Lock;", methodCache: &ReentrantReadWriteLock.readLock_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
