...
open class IntPredicateForward: JNIObjectForward, IntPredicate {
    ...
    open func test( value: Int ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "test", methodSig: "(I)Z", methodCache: &IntPredicateForward.test_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func and( other: IntPredicate? ) -> IntPredicate! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "and", methodSig: "(Ljava/util/function/IntPredicate;)Ljava/util/function/IntPredicate;", methodCache: &IntPredicateForward.and_MethodID_6, args: &__args, locals: &__locals )
    ...
    open func negate() -> IntPredicate! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "negate", methodSig: "()Ljava/util/function/IntPredicate;", methodCache: &IntPredicateForward.negate_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IntPredicateForward( javaObject: __return ) : nil
    }
