...
open class LockSupport: java_swift.JavaObject {
    ...
    private static var parkUntil_MethodID_4: jmethodID?
    ...
    open class func parkUntil( blocker: java_swift.JavaObject?, deadline: Int64 ) {
        ...
        JNIMethod.CallStaticVoidMethod( className: "java/util/concurrent/locks/LockSupport", classCache: &LockSupportJNIClass, methodName: "parkUntil", methodSig: "(Ljava/lang/Object;J)V", methodCache: &parkUntil_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var parkUntil_MethodID_5: jmethodID?

    open class func parkUntil( deadline: Int64 ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: deadline, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "java/util/concurrent/locks/LockSupport", classCache: &LockSupportJNIClass, methodName: "parkUntil", methodSig: "(J)V", methodCache: &parkUntil_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open class func parkNanos( nanos: Int64 ) {
        ...
        JNIMethod.CallStaticVoidMethod( className: "java/util/concurrent/locks/LockSupport", classCache: &LockSupportJNIClass, methodName: "parkNanos", methodSig: "(J)V", methodCache: &parkNanos_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var parkNanos_MethodID_7: jmethodID?
    ...
    open class func parkNanos( blocker: java_swift.JavaObject?, nanos: Int64 ) {
        ...
        JNIMethod.CallStaticVoidMethod( className: "java/util/concurrent/locks/LockSupport", classCache: &LockSupportJNIClass, methodName: "parkNanos", methodSig: "(Ljava/lang/Object;J)V", methodCache: &parkNanos_MethodID_7, args: &__args, locals: &__locals )
    }
