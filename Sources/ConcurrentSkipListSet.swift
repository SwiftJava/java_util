...
open class ConcurrentSkipListSet: AbstractSet, java_lang.Cloneable {///}, /* java.io.Serializable */ UnclassedProtocol {
    ...
    public convenience init( s: SortedSet? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/ConcurrentSkipListSet", classCache: &ConcurrentSkipListSet.ConcurrentSkipListSetJNIClass, methodSig: "(Ljava/util/SortedSet;)V", methodCache: &ConcurrentSkipListSet.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/ConcurrentSkipListSet", classCache: &ConcurrentSkipListSet.ConcurrentSkipListSetJNIClass, methodSig: "()V", methodCache: &ConcurrentSkipListSet.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    override open func clone() throws /* java.lang.CloneNotSupportedException */ -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "clone", methodSig: "()Ljava/lang/Object;", methodCache: &ConcurrentSkipListSet.clone_MethodID_5, args: &__args, locals: &__locals )
...
//    }
    ...
    open func first() -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "first", methodSig: "()Ljava/lang/Object;", methodCache: &ConcurrentSkipListSet.first_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    open func last() -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "last", methodSig: "()Ljava/lang/Object;", methodCache: &ConcurrentSkipListSet.last_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    private static var lower_MethodID_9: jmethodID?
    ...
    open func comparator() -> JavaComparator! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "comparator", methodSig: "()Ljava/util/Comparator;", methodCache: &ConcurrentSkipListSet.comparator_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
