...
open class ZipException: /* class java.io.IOException */ UnavailableObject {
    ...
    private static var ZipExceptionJNIClass: jclass?
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/zip/ZipException", classCache: &ZipException.ZipExceptionJNIClass, methodSig: "()V", methodCache: &ZipException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/zip/ZipException", classCache: &ZipException.ZipExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &ZipException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
