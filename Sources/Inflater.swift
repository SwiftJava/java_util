...
open class Inflater: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.util.zip.Inflater", file, line ) {
            return nil
        }
    ...
    /// private static byte[] java.util.zip.Inflater.emptyBuf
    ...
    open func reset() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "reset", methodSig: "()V", methodCache: &Inflater.reset_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func end() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "end", methodSig: "()V", methodCache: &Inflater.end_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var getBytesWritten_MethodID_9: jmethodID?

    open func getBytesWritten() -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallLongMethod( object: javaObject, methodName: "getBytesWritten", methodSig: "()J", methodCache: &Inflater.getBytesWritten_MethodID_9, args: &__args, locals: &__locals )
    ...
    private static var inflate_MethodID_10: jmethodID?

    open func inflate( arg0: [Int8]? ) throws /* java.util.zip.DataFormatException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "inflate", methodSig: "([B)I", methodCache: &Inflater.inflate_MethodID_10, args: &__args, locals: &__locals )
    ...
    open func inflate( _ _arg0: [Int8]? ) throws /* java.util.zip.DataFormatException */ -> Int {
        return try inflate( arg0: _arg0 )
    }

    /// public int java.util.zip.Inflater.inflate(byte[],int,int) throws java.util.zip.DataFormatException

    private static var inflate_MethodID_11: jmethodID?

    open func inflate( arg0: [Int8]?, arg1: Int, arg2: Int ) throws /* java.util.zip.DataFormatException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 3 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "inflate", methodSig: "([BII)I", methodCache: &Inflater.inflate_MethodID_11, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw DataFormatException( javaObject: throwable )
        }
        return JNIType.decode( type: Int(), from: __return )
    ...
    open func inflate( _ _arg0: [Int8]?, _ _arg1: Int, _ _arg2: Int ) throws /* java.util.zip.DataFormatException */ -> Int {
        return try inflate( arg0: _arg0, arg1: _arg1, arg2: _arg2 )
    }

    /// public boolean java.util.zip.Inflater.needsDictionary()

    private static var needsDictionary_MethodID_12: jmethodID?

    open func needsDictionary() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "needsDictionary", methodSig: "()Z", methodCache: &Inflater.needsDictionary_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    open func needsInput() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "needsInput", methodSig: "()Z", methodCache: &Inflater.needsInput_MethodID_13, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var setDictionary_MethodID_14: jmethodID?
    ...
    open func setDictionary( arg0: [Int8]?, arg1: Int, arg2: Int ) {
        ...
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDictionary", methodSig: "([BII)V", methodCache: &Inflater.setDictionary_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func setDictionary( arg0: [Int8]? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDictionary", methodSig: "([B)V", methodCache: &Inflater.setDictionary_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var getRemaining_MethodID_16: jmethodID?

    open func getRemaining() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRemaining", methodSig: "()I", methodCache: &Inflater.getRemaining_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
    ...
    private static var getAdler_MethodID_17: jmethodID?

    open func getAdler() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAdler", methodSig: "()I", methodCache: &Inflater.getAdler_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
    ...
    private static var getTotalIn_MethodID_18: jmethodID?

    open func getTotalIn() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getTotalIn", methodSig: "()I", methodCache: &Inflater.getTotalIn_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
    ...
    private static var getBytesRead_MethodID_19: jmethodID?

    open func getBytesRead() -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallLongMethod( object: javaObject, methodName: "getBytesRead", methodSig: "()J", methodCache: &Inflater.getBytesRead_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int64(), from: __return )
    }
    ...
    private static var getTotalOut_MethodID_20: jmethodID?

    open func getTotalOut() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getTotalOut", methodSig: "()I", methodCache: &Inflater.getTotalOut_MethodID_20, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
