...
open class Timer: java_swift.JavaObject {
    ...
    public convenience init( isDaemon: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: isDaemon, locals: &__locals )
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/util/Timer", classCache: &Timer.TimerJNIClass, methodSig: "()V", methodCache: &Timer.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( name: String?, isDaemon: Bool ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        __args[1] = JNIType.toJava( value: isDaemon, locals: &__locals )
