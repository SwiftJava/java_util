...
open class CRC32: java_lang.JavaObject, Checksum {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.util.zip.CRC32", file, line ) {
            return nil
        }
    ...
    open func update( arg0: [Int8]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "([B)V", methodCache: &CRC32.update_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func update( arg0: [Int8]?, arg1: Int, arg2: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "([BII)V", methodCache: &CRC32.update_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func update( arg0: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(I)V", methodCache: &CRC32.update_MethodID_6, args: &__args, locals: &__locals )
    }
