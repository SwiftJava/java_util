...
open class ArrayBlockingQueue: AbstractQueue, /* java.io.Serializable */ UnclassedProtocol {
    ...
    public convenience init( arg0: Int, arg1: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/util/concurrent/ArrayBlockingQueue", classCache: &ArrayBlockingQueue.ArrayBlockingQueueJNIClass, methodSig: "(IZ)V", methodCache: &ArrayBlockingQueue.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: Int, arg1: Bool, arg2: Collection? ) {
    ...
    public convenience init( _ _arg0: Int, _ _arg1: Bool, _ _arg2: Collection? ) {
    ...
    open func drainTo( arg0: Collection? ) -> Int {
        ...
        var __locals = [jobject]()
        __args[0] = jvalue( l: arg0?.localJavaObject( &__locals ) )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "drainTo", methodSig: "(Ljava/util/Collection;)I", methodCache: &ArrayBlockingQueue.drainTo_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
