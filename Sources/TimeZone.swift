...
open class TimeZone: java_lang.JavaObject, /* java.io.Serializable */ UnclassedProtocol, java_lang.Cloneable {
    ...
    open func getDisplayName( arg0: Bool, arg1: Int, arg2: JavaLocale? ) -> String! {
        ...
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisplayName", methodSig: "(ZILjava/util/Locale;)Ljava/lang/String;", methodCache: &TimeZone.getDisplayName_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func getDisplayName() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisplayName", methodSig: "()Ljava/lang/String;", methodCache: &TimeZone.getDisplayName_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
    ...
    open func getDisplayName( arg0: JavaLocale? ) -> String! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisplayName", methodSig: "(Ljava/util/Locale;)Ljava/lang/String;", methodCache: &TimeZone.getDisplayName_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.decode( type: String(), from: __return )
    }
    ...
    private static var getTimeZone_MethodID_11: jmethodID?

    open class func getTimeZone( arg0: String? ) -> TimeZone! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/util/TimeZone", classCache: &TimeZoneJNIClass, methodName: "getTimeZone", methodSig: "(Ljava/lang/String;)Ljava/util/TimeZone;", methodCache: &getTimeZone_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? TimeZone( javaObject: __return ) : nil
    }
    ...
    private static var setRawOffset_MethodID_13: jmethodID?

    open func setRawOffset( arg0: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setRawOffset", methodSig: "(I)V", methodCache: &TimeZone.setRawOffset_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func inDaylightTime( arg0: Date? ) -> Bool {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "inDaylightTime", methodSig: "(Ljava/util/Date;)Z", methodCache: &TimeZone.inDaylightTime_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var getAvailableIDs_MethodID_19: jmethodID?

    open class func getAvailableIDs( arg0: Int ) -> [String]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/util/TimeZone", classCache: &TimeZoneJNIClass, methodName: "getAvailableIDs", methodSig: "(I)[Ljava/lang/String;", methodCache: &getAvailableIDs_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.decode( type: [String](), from: __return )
    }
    ...
    private static var getAvailableIDs_MethodID_20: jmethodID?

    open class func getAvailableIDs() -> [String]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/util/TimeZone", classCache: &TimeZoneJNIClass, methodName: "getAvailableIDs", methodSig: "()[Ljava/lang/String;", methodCache: &getAvailableIDs_MethodID_20, args: &__args, locals: &__locals )
        return JNIType.decode( type: [String](), from: __return )
    }
    ...
    private static var hasSameRules_MethodID_21: jmethodID?

    open func hasSameRules( arg0: TimeZone? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "hasSameRules", methodSig: "(Ljava/util/TimeZone;)Z", methodCache: &TimeZone.hasSameRules_MethodID_21, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
