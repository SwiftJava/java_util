...
open class Objects: java_swift.JavaObject {
    ...
    private static var hash_MethodID_1: jmethodID?

    open class func hash( values: [JavaObject]? ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: values, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "java/util/Objects", classCache: &ObjectsJNIClass, methodName: "hash", methodSig: "([Ljava/lang/Object;)I", methodCache: &hash_MethodID_1, args: &__args, locals: &__locals )
    ...
    private static var requireNonNull_MethodID_6: jmethodID?
    ...
    private static var requireNonNull_MethodID_7: jmethodID?
    ...
    private static var compare_MethodID_9: jmethodID?
    ...
    private static var deepEquals_MethodID_10: jmethodID?
    ...
    private static var isNull_MethodID_11: jmethodID?
    ...
    private static var nonNull_MethodID_12: jmethodID?
