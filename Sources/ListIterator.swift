...
open class ListIteratorForward: IteratorForward, ListIterator {
    ...
    override open func remove() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "remove", methodSig: "()V", methodCache: &ListIteratorForward.remove_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    override open func hasNext() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "hasNext", methodSig: "()Z", methodCache: &ListIteratorForward.hasNext_MethodID_13, args: &__args, locals: &__locals )
    ...
    private static var previousIndex_MethodID_15: jmethodID?

    open func previousIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "previousIndex", methodSig: "()I", methodCache: &ListIteratorForward.previousIndex_MethodID_15, args: &__args, locals: &__locals )
    ...
    private static var hasPrevious_MethodID_16: jmethodID?

    open func hasPrevious() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "hasPrevious", methodSig: "()Z", methodCache: &ListIteratorForward.hasPrevious_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func previous() -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "previous", methodSig: "()Ljava/lang/Object;", methodCache: &ListIteratorForward.previous_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    private static var nextIndex_MethodID_18: jmethodID?

    open func nextIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "nextIndex", methodSig: "()I", methodCache: &ListIteratorForward.nextIndex_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var forEachRemaining_MethodID_19: jmethodID?

    override open func forEachRemaining( action: Consumer? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: action, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "forEachRemaining", methodSig: "(Ljava/util/function/Consumer;)V", methodCache: &ListIteratorForward.forEachRemaining_MethodID_19, args: &__args, locals: &__locals )
    }
